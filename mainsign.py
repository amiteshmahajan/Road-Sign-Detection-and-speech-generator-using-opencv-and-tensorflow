...
Course: CS Fall 6600
Authors: Amitesh Mahajan, Vaibhav Sahu
'''
...
ReferenceImages = ["left_turn.jpg","right_turn.jpg","Turn_Around.jpg", "Stop.jpg"]
ReferenceTitles = ["Turn Left Ahead","Right Turn Ahead","U Turn Ahead","Stop Sign Ahead"]
...
symbol= [Symbol() for i in range(4)]
...
def main():
    ...
    for i in range(4):
            ...
            #image = symbol[i].img;
            OriginalFrame = cv2.imread(ReferenceImages[i], cv2.COLOR_BGR2GRAY)
            text = ReferenceTitles[i]
            ...
            for cnt in contours:
                    ...
                    if len(approx)==4:
                            ...
                            if area > minSquareArea:
                                    ...
                                    cv2.putText(OriginalFrame,text, tuple(approx.reshape(4,2)[0]), font, 1, (255,0,255), 2, cv2.LINE_AA)
